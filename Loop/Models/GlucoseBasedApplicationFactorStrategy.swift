...
struct GlucoseBasedApplicationFactorStrategy: ApplicationFactorStrategy {
    ...
    static let maxPartialApplicationFactor = 2.00 // max fraction of correction when glucose > maxGlucoseSlidingScale
    ...
    static let maxGlucoseSlidingScale = 240.0 // mg/dL
